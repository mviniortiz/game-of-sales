...
BEGIN
  ...
  INSERT INTO public.deals
    ...
    ('d1d00000-0000-4000-8000-000000000001', v_company, v_owner, 'Apto 2 dorm - Residencial Aurora', 'Ana Beatriz Moraes', '+5511990002001', 'qualification', 480000, true, 'meta_ads', 45,
     '{"demo_seed":"DEMO.2","interesse_imobiliario":{"empreendimento_interesse":"Residencial Aurora","tipo_imovel":"Apartamento 2 dormitórios","faixa_orcamento":"R$ 450 mil a R$ 520 mil","entrada_disponivel":"R$ 90.000","financiamento":true,"fgts":true,"prazo_compra":"Até 3 meses","corretor_responsavel":"Bruno Tavares","proxima_acao":"Agendar visita ao decorado"},"mapa_decisao":[{"nome":"Ana Beatriz Moraes","papel":"Lead principal"},{"nome":"Marcos Moraes","relacao":"Cônjuge","papel":"Decisor financeiro","origem":"Mencionado na conversa"},{"nome":"Sandra Moraes","relacao":"Mãe","papel":"Apoia entrada","origem":"Informado pelo corretor"}]}'::jsonb,
  ...
  INSERT INTO public.channel_conversations
    ...
    ('d1c00000-0000-4000-8000-000000000011', v_company, v_conn, 'd1c00000-0000-4000-8000-000000000001', 'd1d00000-0000-4000-8000-000000000001', 'open', now()-interval '2 hours 45 minutes', now()-interval '2 hours 45 minutes', now()-interval '2 hours 50 minutes', 1, '{"demo_seed":"DEMO.2"}'::jsonb),
    ('d1c00000-0000-4000-8000-000000000012', v_company, v_conn, 'd1c00000-0000-4000-8000-000000000002', 'd1d00000-0000-4000-8000-000000000002', 'open', now()-interval '21 hours', now()-interval '22 hours', now()-interval '21 hours', 0, '{"demo_seed":"DEMO.2"}'::jsonb),
    ('d1c00000-0000-4000-8000-000000000013', v_company, v_conn, 'd1c00000-0000-4000-8000-000000000003', 'd1d00000-0000-4000-8000-000000000003', 'open', now()-interval '1 day 18 hours', now()-interval '1 day 20 hours', now()-interval '1 day 18 hours', 0, '{"demo_seed":"DEMO.2"}'::jsonb),
    ('d1c00000-0000-4000-8000-000000000014', v_company, v_conn, 'd1c00000-0000-4000-8000-000000000004', 'd1d00000-0000-4000-8000-000000000004', 'open', now()-interval '3 hours 30 minutes', now()-interval '3 hours 30 minutes', now()-interval '4 hours', 1, '{"demo_seed":"DEMO.2"}'::jsonb),
    ('d1c00000-0000-4000-8000-000000000015', v_company, v_conn, 'd1c00000-0000-4000-8000-000000000005', 'd1d00000-0000-4000-8000-000000000005', 'open', now()-interval '1 day 23 hours 50 minutes', now()-interval '2 days', now()-interval '1 day 23 hours 50 minutes', 0, '{"demo_seed":"DEMO.2"}'::jsonb);

  -- ── Mensagens (diálogos completos por conversa) ────────────────────────────
  INSERT INTO public.channel_messages
    ...
    -- Ana Beatriz — Aurora 2 dorm, moradia, financiamento + FGTS (quente)
    ...
    (v_company, v_conn, 'd1c00000-0000-4000-8000-000000000011', 'd1c00000-0000-4000-8000-000000000001', 'demo-ana-2', 'outbound', 'text', 'Oi, Ana! Tudo bem? Aqui é o Bruno, da Incorporadora Aurora. Temos sim unidades de 2 dormitórios. É pra morar ou investir?', '{}'::jsonb, 'sent', now()-interval '2 hours 58 minutes', '{"demo_seed":"DEMO.2"}'::jsonb),
    (v_company, v_conn, 'd1c00000-0000-4000-8000-000000000011', 'd1c00000-0000-4000-8000-000000000001', 'demo-ana-3', 'inbound',  'text', 'É pra morar. Tenho uns 90 mil de entrada e quero financiar o resto, posso usar FGTS.', '{}'::jsonb, 'received', now()-interval '2 hours 55 minutes', '{"demo_seed":"DEMO.2"}'::jsonb),
    (v_company, v_conn, 'd1c00000-0000-4000-8000-000000000011', 'd1c00000-0000-4000-8000-000000000001', 'demo-ana-4', 'outbound', 'text', 'Perfeito! Com 90 mil de entrada e o FGTS dá pra montar um ótimo financiamento. Quer agendar uma visita ao decorado essa semana?', '{}'::jsonb, 'sent', now()-interval '2 hours 50 minutes', '{"demo_seed":"DEMO.2"}'::jsonb),
    (v_company, v_conn, 'd1c00000-0000-4000-8000-000000000011', 'd1c00000-0000-4000-8000-000000000001', 'demo-ana-5', 'inbound',  'text', 'Quero sim! Vou ver os melhores dias com meu marido e te retorno.', '{}'::jsonb, 'received', now()-interval '2 hours 45 minutes', '{"demo_seed":"DEMO.2"}'::jsonb),
    -- Roberto — Vista Park studio, investidor, à vista
    ...
    (v_company, v_conn, 'd1c00000-0000-4000-8000-000000000012', 'd1c00000-0000-4000-8000-000000000002', 'demo-roberto-2', 'outbound', 'text', 'Boa, Roberto! O Vista Park tem ótima liquidez pra locação. Qual retorno mensal você busca? Já te preparo a tabela.', '{}'::jsonb, 'sent', now()-interval '1 day', '{"demo_seed":"DEMO.2"}'::jsonb),
    (v_company, v_conn, 'd1c00000-0000-4000-8000-000000000012', 'd1c00000-0000-4000-8000-000000000002', 'demo-roberto-3', 'inbound',  'text', 'Procuro algo perto de 0,6% ao mês. Manda a tabela que eu analiso.', '{}'::jsonb, 'received', now()-interval '22 hours', '{"demo_seed":"DEMO.2"}'::jsonb),
    (v_company, v_conn, 'd1c00000-0000-4000-8000-000000000012', 'd1c00000-0000-4000-8000-000000000002', 'demo-roberto-4', 'outbound', 'text', 'Fechado. Te envio a tabela do Vista Park com os valores à vista e a estimativa de aluguel.', '{}'::jsonb, 'sent', now()-interval '21 hours', '{"demo_seed":"DEMO.2"}'::jsonb),
    -- Marcos — Jardim Sul MCMV, objeção de parcela, FGTS
    ...
    (v_company, v_conn, 'd1c00000-0000-4000-8000-000000000013', 'd1c00000-0000-4000-8000-000000000003', 'demo-marcos-2', 'outbound', 'text', 'Entendo, Marcos. Dá pra usar o FGTS na entrada e reduzir a parcela. Me passa sua renda aproximada que eu simulo o melhor cenário.', '{}'::jsonb, 'sent', now()-interval '1 day 23 hours', '{"demo_seed":"DEMO.2"}'::jsonb),
    (v_company, v_conn, 'd1c00000-0000-4000-8000-000000000013', 'd1c00000-0000-4000-8000-000000000003', 'demo-marcos-3', 'inbound',  'text', 'Minha renda é uns 4 mil. Tenho uns 15 mil de FGTS.', '{}'::jsonb, 'received', now()-interval '1 day 20 hours', '{"demo_seed":"DEMO.2"}'::jsonb),
    (v_company, v_conn, 'd1c00000-0000-4000-8000-000000000013', 'd1c00000-0000-4000-8000-000000000003', 'demo-marcos-4', 'outbound', 'text', 'Com isso a gente consegue uma boa simulação. Já preparo os números e te mostro a parcela ajustada.', '{}'::jsonb, 'sent', now()-interval '1 day 18 hours', '{"demo_seed":"DEMO.2"}'::jsonb),
    -- Patrícia — Cobertura Aurora, visita sábado, alto padrão (quente)
    ...
    (v_company, v_conn, 'd1c00000-0000-4000-8000-000000000014', 'd1c00000-0000-4000-8000-000000000004', 'demo-patricia-2', 'outbound', 'text', 'Claro, Patrícia! Tenho horário no sábado de manhã pra te mostrar a cobertura. Prefere 10h ou 11h?', '{}'::jsonb, 'sent', now()-interval '4 hours', '{"demo_seed":"DEMO.2"}'::jsonb),
    (v_company, v_conn, 'd1c00000-0000-4000-8000-000000000014', 'd1c00000-0000-4000-8000-000000000004', 'demo-patricia-3', 'inbound',  'text', '11h fica melhor pra mim.', '{}'::jsonb, 'received', now()-interval '3 hours 30 minutes', '{"demo_seed":"DEMO.2"}'::jsonb),
    -- Diego — quer locação, fora do foco de venda
    ...
    (v_company, v_conn, 'd1c00000-0000-4000-8000-000000000015', 'd1c00000-0000-4000-8000-000000000005', 'demo-diego-2', 'outbound', 'text', 'Oi Diego! Hoje trabalhamos com a venda das unidades, não com locação. Se em algum momento pensar em comprar, conta comigo!', '{}'::jsonb, 'sent', now()-interval '1 day 23 hours 50 minutes', '{"demo_seed":"DEMO.2"}'::jsonb);
