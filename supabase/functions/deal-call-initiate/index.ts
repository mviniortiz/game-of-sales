...
serve(async (req) => {
  ...
  try {
    ...
    if (!isSuperAdmin) {
      ...
      // Ligações são ADICIONAL (2026-08-21), não incluso em plano algum.
      // Enquanto não há cobrança de adicional, o gate exige plano pago (pro;
      // "escala"/"enterprise" legados contam como pro).
