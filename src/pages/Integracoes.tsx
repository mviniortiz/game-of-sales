    ...
    >
      ...
      <div className="mt-auto pt-3 border-t border-slate-100 dark:border-slate-700">
        ...
        {integration.status === "available" && (
          <Button
            className="w-full gap-2 bg-emerald-600 hover:bg-emerald-500 text-white h-8 text-sm"
            size="sm"
            onClick={onConnect}
          >
        ...
        {integration.status === "roadmap" && (
          <div className="flex items-center justify-between">
            ...
            <Button
              ...
              onClick={handleVote}
              disabled={hasVoted}
              className={`gap-1 h-7 text-xs ${hasVoted ? "bg-emerald-100 dark:bg-emerald-500/20 text-emerald-600 dark:text-emerald-400" : ""}`}
            >
        ...
        <div className="w-full p-6 space-y-8">
          ...
          {availableIntegrations.length > 0 && (
            <section>
              <div className="flex items-center gap-2 mb-4">
                ...
                <Badge className="bg-emerald-100 dark:bg-emerald-500/20 text-emerald-600 dark:text-emerald-400 border-0 text-xs">
                  Novo
                </Badge>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
          ...
          <div className="p-5 rounded-xl border-2 border-dashed border-slate-300 dark:border-slate-700 bg-slate-100/50 dark:bg-slate-800/30">
            <div className="flex items-center gap-4">
              <div className="p-2.5 rounded-xl bg-emerald-100 dark:bg-emerald-500/20 shrink-0">
                <Puzzle className="w-5 h-5 text-emerald-600 dark:text-emerald-400" />
              </div>
          ...
          <div className="text-xs text-slate-500 dark:text-slate-400 pt-6 border-t border-slate-200 dark:border-slate-800">
            ...
            <Link to="/politica-privacidade" className="text-emerald-600 dark:text-emerald-400 hover:underline">
