            ...
            <div className={`flex-1 flex-col relative w-full h-full md:h-full bg-background z-10 transition-all duration-500 ${!selectedChatId && isMobile ? 'hidden' : 'flex'}`}>
                ...
                {!connected ? (
                    ...
                    <>
                        ...
                        {/* Messages Area */}
                        <div ref={scrollRef} className="flex-1 overflow-y-auto px-4 sm:px-6 py-4 z-10 flex flex-col gap-0.5 scroll-smooth relative bg-background">
                            {isLoadingMessages ? (
                                    ...
                                    <React.Fragment key={msgId}>
                                        ...
                                        >
                                            <div className={`relative ${isVisualMedia
                                                ? `p-1 rounded ${isMe ? 'bg-primary/90' : 'bg-muted'}`
                                            ...
                                            {!isMe && hoveredMsgId === msgId && (
                                                <button
                                                    ...
                                                    className="absolute -right-7 top-1/2 -translate-y-1/2 h-6 w-6 rounded-md bg-muted border border-border flex items-center justify-center text-muted-foreground/70 hover:text-foreground hover:border-white/20 transition-colors"
                                                    title="Responder"
                                                >
                        ...
                        {/* Input Area */}
                        <div className="bg-background border-t border-border px-4 py-2.5 z-10 shrink-0">
                            ...
                            <div className="flex items-center gap-1 bg-muted border border-border rounded-md px-1 focus-within:border-white/[0.12] transition-colors">
                                {/* Left action buttons */}
