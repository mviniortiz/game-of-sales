// Professional Logo Variations for Vyzon
...
export const VyzonLogoV1 = ({ variant = 'full', className = '' }: LogoProps) => {
    if (variant === 'icon') {
        return (
            <svg viewBox="0 0 100 100" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
                {/* Trophy base with growth arrow */}
                <circle cx="50" cy="50" r="45" fill="#00E37A" opacity="0.1" />
                <path d="M50 20 L60 35 L75 35 L62 45 L67 60 L50 50 L33 60 L38 45 L25 35 L40 35 Z" fill="#00E37A" />
                <path d="M45 55 L55 55 L55 75 L60 75 L50 85 L40 75 L45 75 Z" stroke="#00E37A" strokeWidth="3" fill="#d1fae5" />
                <circle cx="50" cy="50" r="42" stroke="#00E37A" strokeWidth="2" fill="none" />
            </svg>
        );
    }
    ...
    return (
        <svg viewBox="0 0 300 80" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
            {/* Icon */}
            <circle cx="40" cy="40" r="35" fill="#00E37A" opacity="0.1" />
            <path d="M40 15 L48 27 L62 27 L51 35 L55 48 L40 40 L25 48 L29 35 L18 27 L32 27 Z" fill="#00E37A" />
            <path d="M36 43 L44 43 L44 60 L48 60 L40 68 L32 60 L36 60 Z" stroke="#00E37A" strokeWidth="2.5" fill="#d1fae5" />

            {/* Text */}
            <text x="85" y="50" fontFamily="system-ui, -apple-system, sans-serif" fontSize="32" fontWeight="700" fill="#1e293b">
                GAME <tspan fill="#00E37A">SALES</tspan>
            </text>
        </svg>
    );
};
...
export const VyzonLogoV2 = ({ variant = 'full', className = '' }: LogoProps) => {
    if (variant === 'icon') {
        return (
            <svg viewBox="0 0 100 100" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <defs>
                    <linearGradient id="emeraldGrad" x1="0%" y1="0%" x2="100%" y2="100%">
                        ...
                        <stop offset="100%" stopColor="#00B289" />
                    </linearGradient>
                </defs>
                <circle cx="50" cy="50" r="42" stroke="url(#emeraldGrad)" strokeWidth="4" fill="white" />

                {/* GS letters integrated */}
                <path d="M35 35 Q30 35 30 40 L30 60 Q30 65 35 65 L45 65 L45 58 L37 58 L37 52 L45 52 L45 45 L35 45 L35 42 L45 42 L45 35 Z" fill="#00E37A" />
                ...
                <path d="M70 25 L75 30 L70 35" stroke="#00E37A" strokeWidth="2.5" strokeLinecap="round" fill="none" />
            </svg>
        );
    }
    ...
    return (
        <svg viewBox="0 0 320 80" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M28 28 Q24 28 24 32 L24 48 Q24 52 28 52 L36 52 L36 47 L29 47 L29 42 L36 42 L36 37 L28 37 L28 33 L36 33 L36 28 Z" fill="#00E37A" />
            ...
            <path d="M56 20 L60 24 L56 28" stroke="#00E37A" strokeWidth="2" strokeLinecap="round" fill="none" />
...
export const VyzonLogoV3 = ({ variant = 'full', className = '' }: LogoProps) => {
    if (variant === 'icon') {
        return (
            <svg viewBox="0 0 100 100" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
                <defs>
