...
interface GreennConfigModalProps {
    open: boolean;
    onClose: () => void;
    onSaved?: () => void;
}

export const GreennConfigModal = ({ open, onClose, onSaved }: GreennConfigModalProps) => {
    ...
    const loadConfig = async () => {
        ...
        try {
            ...
            console.error("Error loading Greenn config:", error);
        } finally {
            setIsLoading(false);
        }
    };
    ...
    const handleSave = async () => {
        ...
        if (!apiToken.trim()) {
            toast.error("Por favor, insira o token da API");
            return;
        }
                    ...
                    <div className="space-y-6 py-4">
                        ...
                        <div className="space-y-2">
                            <div className="flex items-center gap-2">
                                ...
                                <a
                                    href="https://app.greenn.com.br/integrations"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="text-emerald-500 hover:text-emerald-600"
                                    title="Onde encontrar o token da API"
                                >
