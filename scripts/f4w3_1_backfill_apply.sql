-- ─────────────────────────────────────────────────────────────────────────────
-- F4W.3.1 — Backfill histórico whatsapp_messages → channel_* (APPLY)
--
-- IDÊNTICO ao dryrun, mas COMMIT em vez de ROLLBACK. Persiste de verdade.
-- Rode o dryrun primeiro e revise o relatório antes de aplicar.
--
